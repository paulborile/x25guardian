...
/*
 * $Id: sm_list_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $
 *
...
static char rcsid[] = "$Id: sm_list_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $";
...
int sm_list_route()
{
    ...
    if (( status = list_route_1((void *)NULL, cl)) != NULL)
    {
        return(*status);
    }
    else
