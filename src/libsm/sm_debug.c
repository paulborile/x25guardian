/*
 * $Id: sm_debug.c,v 1.1.1.1 1998/11/18 15:03:08 paul Exp $
 *
...
static char rcsid[] = "$Id: sm_debug.c,v 1.1.1.1 1998/11/18 15:03:08 paul Exp $";
...
int level;
{
    ...
    if (( status = init_debug_1(&level, cl)) != NULL )
    {
        return(*status);
    }
    else
