/*
 * $Id: sm_load_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $
 *
...
static char rcsid[] = "$Id: sm_load_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $";
...
int sm_load_route()
{
    ...
    if (( status = load_1((void *)NULL, cl)) != NULL)
    {
        return(*status);
    }
    else
