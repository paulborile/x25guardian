/*
 * $Id: sm_incr_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $
 *
...
static char rcsid[] = "$Id: sm_incr_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $";
...
char *link;
{
    ...
    if (( status = incr_route_1(&n, cl)) != NULL )
    {
        sm_errno = 0;
        return(*status);
    }
