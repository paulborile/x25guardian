/*
 * $Id: sm_dump_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $
 *
...
static char rcsid[] = "$Id: sm_dump_rt.c,v 1.1.1.1 1998/11/18 15:03:09 paul Exp $";
